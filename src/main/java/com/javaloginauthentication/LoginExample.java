...
class LoginExample {
    ...
    static final String USER = dotenv.get("USERNAME2");
    static final String IPADDRESS = dotenv.get("IPADDRESS");
    static final String PASSWORD = dotenv.get("PASSWORD");
    static final String CLIENT_TYPE = dotenv.get("CLIENT_TYPE");
    ...
    public static void login() throws Exception {
        ...
        //debug - pegar username e ip
        System.out.println("USERNAME2: " + dotenv.get("USERNAME2"));
        System.out.println("IPADDRESS: " + dotenv.get("IPADDRESS"));
        System.out.println(AUTH_URL);

        //Parâmetros do primeiro login
        Map<String, Object> firstLoginParams = new HashMap<>(3);
        firstLoginParams.put("userName", USER);
        firstLoginParams.put("ipAddress", IPADDRESS);
        firstLoginParams.put("clientType", CLIENT_TYPE);
        ...
        String signature = generateSignature(USER, PASSWORD, realm, randomKey);
        ...
        secondLoginParams.put("userName", USER); 
        ...
        secondLoginParams.put("ipAddress", IPADDRESS); 
        ...
        System.out.println(String.format("your privateKeyWithBase64, you can decrypt secretKeyWithRsa and secretVectorWithRsa with it: %s", privateKeyWithBase64)); 
        ...
        if (HEART_COUNT % 60 == 0) { 
            ...
            JSONObject udpateTokenResponse = JSONObject.parseObject(sendPostOrPut(UPDATE_TOKEN_URL, updateTokenParamMap, POST)); 
    ...
    static String sendPostOrPut(String url, Map<String, Object> params, String requestMode) throws ClientProtocolException, IOException {
